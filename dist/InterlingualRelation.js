(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./Relation", "./InterlingualDependencyType"], factory);
    }
    ...
    InterlingualRelation.ilrDependency = ["Hypernym", "Near_antonym", "Holo_member", "Holo_part", "Holo_portion",
        "Usage_domain", "Category_domain", "Be_in_state", "Subevent", "Verb_group",
        "Similar_to", "Also_see", "Causes", "SYNONYM"];
    InterlingualRelation.interlingualDependencyTags = [InterlingualDependencyType_1.InterlingualDependencyType.HYPERNYM,
