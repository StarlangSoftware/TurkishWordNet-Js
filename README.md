...
[C++](https://github.com/starlangsoftware/TurkishWordNet-CPP) or [C#](https://github.com/starlangsoftware/TurkishWordNet-CS) repository.
...
## Npm Install
	...
	npm install nlptoolkit-wordnet
...
A directory called util will be created. Or you can use below link for exploring the code:
	...
	git clone https://github.com/starlangsoftware/turkishwordnet-js.git
...
To load a particular WordNet,
	...
	let domain = new WordNet("domain_wordnet.xml", "tr");

To bring all the synsets,

	Array<SynSet> getSynSetList()
...
For example, all the literals inside a synonym can be found with the following:
	...
	for (let i = 0; i < synonym.LiteralSize(); i++){
		let literal = synonym.getLiteral(i);
		...
	}
